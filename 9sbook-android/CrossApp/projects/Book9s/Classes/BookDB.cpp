...
void BookDB::HttpRequest( std::string url , CCObject *pTarget , SEL_BookDBOnComplete onComplete , SEL_BookDBOnHttpComplete onHttpComplete , void *pUserData , int nThread )
{
...
void BookDB::OpenRank( CCObject *pTarget , SEL_BookDBOnComplete onComplete )
{
...
void BookDB::Search( std::string strSearchKey , std::string strSearchType , CCObject *pTarget , SEL_BookDBOnComplete onComplete )
{
...
void BookDB::GetBookInfo( BookData *pBook , CCObject *pTarget , SEL_BookDBOnComplete onComplete )
{
...
void BookDB::GetBookMenu( BookData *pBook , CCObject *pTarget , SEL_BookDBOnComplete onComplete )
{
	// 先从本地查找
	BookData bookData;
...
void BookDB::DownloadBook( BookData *pBook , int start_menu , int end_menu , CCObject *pTarget , SEL_BookDBOnComplete onComplete )
{
	sqlite3 *pSql = NULL;
...
void BookDB::ReadBook( BookData *pBook , int menu , CCObject *pTarget , SEL_BookDBOnComplete onComplete )
{
	// 先从本地数据库查找
	BookData bookData;
	if ( FindStorage( pBook->GetKeyName() , &bookData ) )
