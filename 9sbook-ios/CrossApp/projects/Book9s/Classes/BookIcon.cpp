...
bool BookIcon::init()
{
	...
	if ( m_nStyle == BookIcon::STYLE_ICON_WITH_NAME )
	{
		...
		m_pIcon->setFrame( CCRect( 0 , 0 , 0 , 0 ) );
		addSubview( m_pIcon );

		m_pTitleBk = CAImageView::createWithImage( CAImage::create( "BookTitleBk.png" ) );
		m_pTitleBk->setFrame( CCRect( 0 , m_pIcon->getFrame().size.height - 75 , m_pIcon->getFrame().size.width , 75 ) );
		m_pTitleBk->setVisible( false );
		addSubview( m_pTitleBk );

		m_pBookName = CALabel::createWithFrame( CCRect( 4 , m_pIcon->getFrame().size.height - 75 , m_pIcon->getFrame().size.width - 4 * 2 , 40 ) );
		...
		m_pAuthor = CALabel::createWithFrame( CCRect( 4 , m_pIcon->getFrame().size.height - 35 , m_pIcon->getFrame().size.width - 4 * 2 , m_pIcon->getFrame().size.height ) );
	...
	{
		setFrame( CCRect( 0 , 0 , 720 , GetIconHeight( m_nStyle ) ) );

		m_pBookName = CALabel::createWithFrame( CCRect( 14 , 18 , getFrame().size.width - 14 * 2 , 45 ) );
		m_pBookName->setTextAlignment( CATextAlignmentLeft );
		m_pBookName->setFontSize( 32 );
		m_pBookName->setVerticalTextAlignmet(CAVerticalTextAlignmentTop);
		m_pBookName->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		m_pBookName->setNumberOfLine( 1 );
		addSubview( m_pBookName );

		CALabel *pLabel = CALabel::createWithFrame( CCRect( 330 , 34 , 720 , 45 ) );
		pLabel->setTextAlignment( CATextAlignmentLeft );
		pLabel->setFontSize( 24 );
		pLabel->setColor( ccc4( 34 , 168 , 109 , 255 ) );
		pLabel->setText( UTF8("作者：") );
		addSubview( pLabel );

		m_pAuthor = CALabel::createWithFrame( CCRect( 394 , 34 , getFrame().size.width , getFrame().size.height ) );
		m_pAuthor->setTextAlignment( CATextAlignmentLeft );
		m_pAuthor->setFontSize( 24 );
		m_pAuthor->setColor( ccc4( 34 , 168 , 109 , 255 ) );
		addSubview( m_pAuthor );

		pLabel = CALabel::createWithFrame( CCRect( 573 , 34 , 720 , 45 ) );
		pLabel->setTextAlignment( CATextAlignmentLeft );
		pLabel->setFontSize( 24 );
		...
		m_pWordSize = CALabel::createWithFrame( CCRect( 637 , 34 , getFrame().size.width , getFrame().size.height ) );
		m_pWordSize->setTextAlignment( CATextAlignmentLeft );
		m_pWordSize->setFontSize( 24 );
		m_pWordSize->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		addSubview( m_pWordSize );

		m_pLastChapter = CALabel::createWithFrame( CCRect( 14 , 78 , 702 , 28 ) );
		m_pLastChapter->setTextAlignment( CATextAlignmentLeft );
		m_pLastChapter->setFontSize( 24 );
	...
	else if ( m_nStyle == BookIcon::STYLE_ICON_IN_LIST )
	{
		...
		m_pIcon = CAImageView::createWithImage( CAImage::create( "BookIcon.png" ) );
		m_pIcon->setFrame( CCRect( 18 , 18 , 94 , 133 ) );
		addSubview( m_pIcon );

		m_pBookName = CALabel::createWithFrame( CCRect( 150 , 18 , getFrame().size.width - 150 * 2 , 40 ) );
		m_pBookName->setTextAlignment( CATextAlignmentLeft );
		m_pBookName->setFontSize( 28 );
		m_pBookName->setVerticalTextAlignmet(CAVerticalTextAlignmentTop);
		m_pBookName->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		...
		m_pAuthor = CALabel::createWithFrame( CCRect( 150 , 72 , getFrame().size.width , getFrame().size.height ) );
		m_pAuthor->setTextAlignment( CATextAlignmentLeft );
		m_pAuthor->setFontSize( 20 );
		m_pAuthor->setColor( ccc4( 34 , 168 , 109 , 255 ) );
		addSubview( m_pAuthor );

		m_pBookInfo = CALabel::createWithFrame( CCRect( 150 , 104 , 530 , 50 ) );
	...
	else if ( m_nStyle == BookIcon::STYLE_ICON_AND_INFO )
	{
		...
		m_pIcon = CAImageView::createWithImage( CAImage::create( "BookIcon.png" ) );
		m_pIcon->setFrame( CCRect( 25 , 25 , 0 , 0 ) );
		addSubview( m_pIcon );
		...
		m_pBookName = CALabel::createWithFrame( CCRect( 250 , 25 , getFrame().size.width - 250 * 2 , 60 ) );
		m_pBookName->setTextAlignment( CATextAlignmentLeft );
		m_pBookName->setFontSize( 40 );
		m_pBookName->setVerticalTextAlignmet(CAVerticalTextAlignmentTop);
		m_pBookName->setColor( ccc4( 34 , 168 , 109 , 255 ) );
		m_pBookName->setNumberOfLine( 1 );
		addSubview( m_pBookName );

		CALabel *pLabel = CALabel::createWithFrame( CCRect( 250 , 90 , 720 , 45 ) );
		pLabel->setTextAlignment( CATextAlignmentLeft );
		...
		m_pAuthor = CALabel::createWithFrame( CCRect( 350 , 90 , 720 , 45 ) );
		m_pAuthor->setTextAlignment( CATextAlignmentLeft );
		m_pAuthor->setFontSize( 28 );
		m_pAuthor->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		addSubview( m_pAuthor );

		pLabel = CALabel::createWithFrame( CCRect( 250 , 150 , 720 , 45 ) );
		pLabel->setTextAlignment( CATextAlignmentLeft );
		pLabel->setFontSize( 28 );
		pLabel->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		pLabel->setText( UTF8("字数：") );
		...
		m_pWordSize = CALabel::createWithFrame( CCRect( 350 , 150 , 720 , 45 ) );
		m_pWordSize->setTextAlignment( CATextAlignmentLeft );
		m_pWordSize->setFontSize( 28 );
		m_pWordSize->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		addSubview( m_pWordSize );

		pLabel = CALabel::createWithFrame( CCRect( 250 , 210 , 720 , 45 ) );
		pLabel->setTextAlignment( CATextAlignmentLeft );
		pLabel->setFontSize( 28 );
		pLabel->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		...
		m_pFromNetName = CALabel::createWithFrame( CCRect( 350 , 210 , 720 , 45 ) );
		m_pFromNetName->setTextAlignment( CATextAlignmentLeft );
		m_pFromNetName->setFontSize( 28 );
		m_pFromNetName->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		addSubview( m_pFromNetName );

		pLabel = CALabel::createWithFrame( CCRect( 250 , 270 , 720 , 45 ) );
		pLabel->setTextAlignment( CATextAlignmentLeft );
		pLabel->setFontSize( 28 );
		pLabel->setColor( ccc4( 255 , 255 , 255 , 255 ) );
		...
		m_pLastChapter = CALabel::createWithFrame( CCRect( 350 , 270 , 720 , 45 ) );
		m_pLastChapter->setTextAlignment( CATextAlignmentLeft );
		m_pLastChapter->setFontSize( 28 );
...
int BookIcon::GetIconHeight( int style )
{
	switch( style )
	{
	case BookIcon::STYLE_ICON_WITH_NAME: return 267;
	case BookIcon::STYLE_NOICON_IN_LIST: return 110;
	case BookIcon::STYLE_ICON_IN_LIST: return 170;
	case BookIcon::STYLE_ICON_AND_INFO: return 315;
	}
	return 0;
}
...
bool BookIcon::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent)
{
...
void BookIcon::ccTouchMoved(CCTouch *pTouch, CCEvent *pEvent)
{
	CAScheduler::unschedule( schedule_selector( BookIcon::OnHold ) , this );
}
void BookIcon::ccTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
