...
void OpenIE(const char *strUrl)
{
    LhWebView *web = new LhWebView();
    web->initWithUrl(strUrl);
    CCDirector::sharedDirector()->getRootWindow()->addSubview(web);
    web->release();
}
#endif
...
bool adView::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent)
{
