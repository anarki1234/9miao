...
{
	CC_RETURN_IF(CAScheduler::isScheduled(schedule_selector(CANavigationController::update), this));
...
{
	CC_RETURN_IF(CAScheduler::isScheduled(schedule_selector(CATabBarController::update), this));
